...
function getPriority(urlPath) {
  ...
  if (/^(wheel-of-names|random-name-picker|random-wheel|giveaway-picker|best-free-wheel-spinner|random-state-picker|random-country-picker)$/.test(urlPath)) return '0.9';
